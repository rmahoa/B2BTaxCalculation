...
public enum ChainTransactionPhaseCodeType {
    ...
    /**
     * A third-party entity between the manufacturer that creates the good or tangible property and the final consumer of the good or property. This is a Domestic VAT scenario.
     * 
     */
    INTERMEDIARY,

    /**
     * An entity that is the final consumer of the good or tangible property. This is an Intra-EU, Zero Rate VAT scenario.
     * 
     */
    FINAL;
