 ...
 *       &lt;sequence>
 *         &lt;element name="Buyer" type="{urn:vertexinc:o-series:tps:7:0}InvoiceVerificationBuyerType" minOccurs="0"/>
 *         &lt;element name="Vendor" type="{urn:vertexinc:o-series:tps:7:0}VendorType" minOccurs="0"/>
 ...
 *         &lt;element ref="{urn:vertexinc:o-series:tps:7:0}Purchase" minOccurs="0"/>
 ...
 *         &lt;element name="UnitPrice" type="{urn:vertexinc:o-series:tps:7:0}AmountType" minOccurs="0"/>
 *         &lt;element ref="{urn:vertexinc:o-series:tps:7:0}ExtendedPrice" minOccurs="0"/>
 *         &lt;element ref="{urn:vertexinc:o-series:tps:7:0}ChargedTax" minOccurs="0"/>
 *         &lt;element name="OutsideThreshold" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="Variance" type="{urn:vertexinc:o-series:tps:7:0}AmountType" minOccurs="0"/>
 *         &lt;element ref="{urn:vertexinc:o-series:tps:7:0}AmountBilledToDate" minOccurs="0"/>
 *         &lt;element name="Taxes" type="{urn:vertexinc:o-series:tps:7:0}TaxesType" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="AssistedParameters" type="{urn:vertexinc:o-series:tps:7:0}AssistedParametersType" minOccurs="0"/>
 *         &lt;element name="LineItem" type="{urn:vertexinc:o-series:tps:7:0}LineItemAPIOType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *       &lt;attGroup ref="{urn:vertexinc:o-series:tps:7:0}APInvoiceSyncLineItemGroup"/>
 *       &lt;attribute name="syncType" type="{urn:vertexinc:o-series:tps:7:0}SyncronizationCodeType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class LineItemAPIOType {
    ...
    protected InvoiceVerificationBuyerType buyer;
     ...
     * @return
     *     possible object is
     *     {@link InvoiceVerificationBuyerType }
     *     
     */
    public InvoiceVerificationBuyerType getBuyer() {
        return buyer;
    }
     ...
     *     
     */
    public void setBuyer(InvoiceVerificationBuyerType value) {
        this.buyer = value;
    }
