...
public enum InputOutputCodeType {
    ...
    /**
     * Input VAT is the VAT you incur as part of the purchase price of your goods or services. This is the VAT paid to the Vendor on purchases.
     * 
     */
    INPUT,
     ...
     * 
     * For VAT purposes, the jurisdictions (countries) in the EU are affiliated together as a trade block. The EU acts as a single jurisdiction (country) for VAT purposes. Specific territories that trade with the EU are excluded from VAT.  These territories are the Island of Heligoland and the territory of Büsingen  (Germany); Ceuta, Melilla, and Canary Island (Spain); Livigno, Campione d'Italia, and Tthe Italian waters of Lake Lugano (Italy); the French Overseas Departments of Guadeloupe, French Guiana, Martinque and  and Reunion, and Monaco (France); Mount Athos, also known asa Agion Poros (Greece);  Åland Islands, (Finland), the  Isle of Man (United Kingdom); and Akrotiri and Dhekelia (Cyprus).
     * 
     */
    IMPORT,

    /**
     * Output VAT is the VAT you add to the sale price of your goods or services. This is the VAT charged by the Taxpayer on sales.
     * 
     */
    OUTPUT,

    /**
     * Input_Output is the code used to specify the application of a reverse charge. In this case, the buyer has accounted for the VAT due.
     * 
     */
    INPUT_OUTPUT;
