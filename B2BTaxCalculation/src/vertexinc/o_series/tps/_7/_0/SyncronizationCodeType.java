...
public enum SyncronizationCodeType {
    ...
    /**
     * O Series synchronization modifies a line item. The line item to be modified must have existed on a previous transaction.
     * 
     */
    MODIFY,

    /**
     * O Series synchronization deletes a line item. The line item to be deleted must have existed on a previous transaction.
     * 
     * 
     */
    DELETE;
