...
public enum LookupResultType {
    ...
    /**
     * The confidence indicator value indicates the strength of the Tax Area lookup result.
     *  
     * The confidence indicator was supressed because one of the following was true: (1) the ZIP Code was missing in a lookup for a United States address, or (2) the lookup was for an address in Canada.
     * 
     */
